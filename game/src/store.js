...
import {
  showBackButton, haptic, openExternal, deviceKind,
} from './telegram.js';
import {
...
/**
 * One coin pack, paid in ringgit (TNG / card through Revenue Monster). Stars
 * were removed on Sep 26 (the user's call): real money only.
 */
