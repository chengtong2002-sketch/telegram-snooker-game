...
import {
  ...
  balanceUpdatedMessage, paySupportMessage, termsMessage,
...
const ALL = {
  ...
  'match over (idle forfeit, won)': () => matchOverMessage({ won: true, framesWon: [0, 0], conceded: true, forfeit: 'idle' }),
  'match over (idle forfeit, lost)': () => matchOverMessage({
